...
public class StubMapping {
  ...
  public static final StubMapping NOT_CONFIGURED = new StubMapping(new RequestPattern(),
      ResponseDefinition.notConfigured());
  ...
  public int hashCode() {
    final int prime = 31;
    int result = 1;
    result = prime * result + (int) (insertionIndex ^ (insertionIndex >>> 32));
    result = prime * result + ((filePath == null) ? 0 : filePath.hashCode());
    result = prime * result + ((newScenarioState == null) ? 0 : newScenarioState.hashCode());
    result = prime * result + ((priority == null) ? 0 : priority.hashCode());
    result = prime * result + ((request == null) ? 0 : request.hashCode());
    result =
        prime * result + ((requiredScenarioState == null) ? 0 : requiredScenarioState.hashCode());
